...
const MAX_RENDERED_RESCUE = 5;
const MAX_RENDERED_ZONE_ITEMS = 24;
const MAX_RENDERED_LEDGER = 12;
const MAX_INGREDIENT_LIBRARY = 180;
const MAX_LIBRARY_SUGGESTIONS = 6;
const MAX_LIBRARY_LIST = 80;
